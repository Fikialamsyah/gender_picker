            ...
            child: Column(
              ...
              children: [
                Consumer<GenderProvider>(
                  builder: (context, genderProvider, _) => Text("Gender Picker",
                      style: TextStyle(
                          fontSize: 24,
                        ...
                        builder: (context, genderProvider, _) => GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                border: Border.all(color: genderProvider.maleColor),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  "Male",
                                  style: TextStyle(
                                      fontSize: 20, fontWeight: FontWeight.bold, color: genderProvider.maleColor),
                                )
                              ],
                            ),
                          ),
                      ...
                      child: Consumer<GenderProvider>(
                        builder: (context, genderProvider, _) => GestureDetector(
                          ...
                          child: Container(
                            height: 150,
                            decoration: BoxDecoration(
                                border: Border.all(color: genderProvider.femaleColor),
                                borderRadius: BorderRadius.circular(12)),
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                ...
                                Text(
                                  "Female",
                                  style: TextStyle(
                                      fontSize: 20, fontWeight: FontWeight.bold, color: genderProvider.femaleColor),
                                )
                              ],
                            ),
                          ),
